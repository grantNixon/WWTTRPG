...
class Backgrounds():
    backgrounds = ["Cowboy", "Rancher", "Bounty Hunter", "Snake Oil Salesman", "Shopkeep", "Doctor", "Elemental Fella", "Wilderness Guide", "Worshipper", "Missionary", "Galvanism Scholar", "Chef"
                   "Alchemist", "Ex-convict", "Carpenter","Pack Mule","Shockstone Researcher","Luddite","Assassin", "Street Rat"]
...
class Skills_to_ModelName():
    skilldic = {"Shotguns":"sk_shotguns","Crushing Melee":"sk_crushing", "Hand-to-Hand":"sk_hand","Athletics":"sk_athletics","Crafting":"sk_crafting","Pistols":"sk_pistols","Slashing Melee":"sk_slashing", "Archery":"sk_archery","Ropework":"sk_ropework",
